...
export const GET: APIRoute = ({ site }) => {
  ...
  const rqV1Paths = ['/ukazky/instalater/', '/ukazky/sluzba/', '/ukazky/eshop/', '/ukazky/chatbot/', '/zapisky/', '/zapisky/web-pro-zivnostnika-cena/', '/zapisky/vlastni-eshop-nebo-shoptet/', '/zapisky/jak-se-staram-o-web-po-predani/'];
  const paths = [
    '/',
    '/en/',
    ...routePagePaths,
