...
const csProblems: HomeContent['problems']['items'] = [
  ...
  },
  {
    ...
    cause: 'Odpovědi nejsou připravené jako schválené podklady a AI pomocník nemá z čeho bezpečně vycházet.',
  ...
  },
  {
    ...
    cause: 'Chybí jednoduchý automatický první kontakt, který potvrdí přijetí, položí doplňující otázky a předá věc dál.',
  ...
  },
  {
    ...
    step: 'optimalizace obrázků a skriptů, cacheování, případně rychlejší hosting.',
  ...
  },
  {
    ...
    problem: 'E-shop chybí v organickém vyhledávání, protože nemá SEO základ.',
  ...
  },
  {
    ...
    cause: 'špatně navržený proces, žádné šablony, duplikace ani hromadný import.',
  ...
  },
  {
    ...
    symptom: 'Drahé pluginy, nic si neupravím sám',
    problem: 'Provoz drží drahé pluginy a i drobná úprava vyžaduje technika.',
    cause: 'platforma nutí řešit běžné věci placenými rozšířeními; chybí jednoduchý editor.',
    verify: 'roční náklady na pluginy, co reálně dělají a které úpravy byste chtěl zvládnout sám.',
  ...
  },
  {
    ...
    symptom: 'Nevíte, kdo jsou vaši zákazníci',
    problem: 'O zákaznících a jejich cestě máte málo dat, takže se špatně rozhodujete.',
